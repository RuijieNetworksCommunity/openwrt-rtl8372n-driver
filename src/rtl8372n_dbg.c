...
static int sds_page5_read(struct seq_file *seq, void *v)
{
    ...
    rtl8372n_sds_regbits_read(0LL, 5LL, 0LL, 1LL, &v3);
    seq_printf(seq, "sds page 5  reg 0; bit0 = %#x\n", v3);
    rtl8372n_sds_regbits_read(0LL, 5LL, 1LL, 255LL, &v3);
